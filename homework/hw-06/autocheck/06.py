...
# a = ["60b90c3b13067a15887e1ae4", "Watermelon Cucumber Salad", "1 large seedless watermelon", "12 leaves fresh mint", "1 cup crumbled feta cheese"]
# b = a[2:]
# print(b)
...
def get_recipe(path, search_id) -> dict:
    ...
    with open(path, 'r') as file:
        while True:
            ...
            if my_list[0] == search_id:
                my_dict = {
                    "id":my_list[0],
                    "name":my_list[1],
                    "ingredients":my_list[2:]
                }
...
def main():
    path = 'D:\\projects\\python-course-2023\\homework\\hw-06\\06_file.txt'
